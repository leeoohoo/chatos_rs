...
#[derive(Debug, Clone)]
pub struct ResearchExtractExecution {
    pub backend: String,
...
pub struct ResearchExtractStats {
...
pub async fn run_research_with_fallback(
    client: &Client,
    query: &str,
    search_limit: usize,
...
pub fn compute_research_extract_stats(pages: &[ExtractedPage]) -> ResearchExtractStats {
