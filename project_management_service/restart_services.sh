...
PROJECT_SERVICE_FRONTEND_BASE_PATH="${PROJECT_SERVICE_FRONTEND_BASE_PATH:-${VITE_BASE_PATH:-/}}"
...
PROJECT_SERVICE_VITE_API_BASE_URL="${PROJECT_SERVICE_VITE_API_BASE_URL:-/}"
PROJECT_SERVICE_API_PROXY_TARGET="${PROJECT_SERVICE_API_PROXY_TARGET:-http://127.0.0.1:${PROJECT_SERVICE_PORT}}"
...
start_frontend() {
  ...
  launch_service \
    ...
    "$FRONTEND_PID_FILE" \
    "$FRONTEND_LOG_FILE" \
    "cd \"$FRONTEND_DIR\" && PROJECT_SERVICE_FRONTEND_PORT=\"$PROJECT_SERVICE_FRONTEND_PORT\" PROJECT_SERVICE_API_PROXY_TARGET=\"$PROJECT_SERVICE_API_PROXY_TARGET\" VITE_BASE_PATH=\"$PROJECT_SERVICE_FRONTEND_BASE_PATH\" VITE_API_BASE_URL=\"$PROJECT_SERVICE_VITE_API_BASE_URL\" exec npm run dev -- --host 0.0.0.0 --port \"$PROJECT_SERVICE_FRONTEND_PORT\""
}
