...
fn internal_skill_manifest(skill_id: &str) -> Option<&'static str> {
    match skill_id {
        ...
        "internal_skill_pdf" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/pdf/1.14.0/skill.json"
        )),
        ...
        "internal_skill_computer_use" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/computer-use/1.18.0/skill.json"
        )),
...
fn internal_skill_instructions(skill_id: &str) -> Option<&'static str> {
    match skill_id {
        ...
        "internal_skill_pdf" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/pdf/1.14.0/instructions.md"
        )),
        "internal_skill_presentations" => Some(include_str!(
        ...
        "internal_skill_computer_use" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/computer-use/1.18.0/instructions.md"
        )),
        "internal_skill_excel_live_control" => Some(include_str!(
