...
pub(super) fn definitions(now: &str) -> Vec<ConfigDefinitionRecord> {
    vec![
        definition(
            ...
            "string",
            json!("chatos,task-runner,configuration-center"),
            None,
            None,
            &[],
            "restart_required",
        ...
        definition(
            ...
            Some("mcp-management-service"),
            "string",
            json!("postgresql://mcp_management_app:change_me@127.0.0.1:5433/mcp_management_service"),
            None,
            None,
            &[],
            "restart_required",
        ...
        definition(
            ...
            "Runtime 过期数据清理间隔（秒）",
            "MCP Management 分批物理删除过期 runtime session、close result 和 skill activation 的间隔",
            "MCP Management / Runtime Retention",
            "service",
            Some("mcp-management-service"),
            "integer",
            json!(60),
        ...
        definition(
            ...
            "Runtime 过期数据清理批量",
            "MCP Management 每轮、每张表最多物理删除的过期 runtime session 相关记录数",
            "MCP Management / Runtime Retention",
            "service",
            Some("mcp-management-service"),
            "integer",
