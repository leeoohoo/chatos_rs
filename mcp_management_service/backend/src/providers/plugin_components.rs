...
use chatos_plugin_management_sdk::{
    plugin_agent_snapshot_sha256, plugin_command_snapshot_sha256, PluginComponentKind,
...
impl PluginComponentProvider {
    pub(super) fn new(
        ...
        let http = reqwest::Client::builder()
            ...
            .build()
            .map_err(|error| format!("build Plugin Component Provider client failed: {error}"))?;
        Ok(Self {
            http,
    ...
    pub(super) async fn close_local_bindings(
        &self,
        owner_user_id: &str,
        runtime_session_id: &str,
