...
const TOOL_ARGUMENT_ALLOWLIST: Record<string, Set<string>> = {
  ...
  'code:open_edit_session': new Set(['purpose']),
  'code:stage_edit_batch': new Set(['session_id', 'operations']),
  'code:commit_edit_session': new Set(['session_id']),
  'code:abort_edit_session': new Set(['session_id']),
  'browser:browser_open': new Set(['url']),
  'browser:browser_tabs': new Set([]),
  'browser:browser_tab_new': new Set(['url']),
  'browser:browser_tab_switch': new Set(['tab_id']),
  'browser:browser_tab_close': new Set(['tab_id']),
  ...
  'browser:browser_upload': new Set(['ref', 'paths']),
  'browser:browser_download': new Set(['ref', 'path']),
  'browser:browser_console': new Set(['clear', 'expression']),
  'browser:browser_network': new Set(['clear', 'limit', 'filter', 'resource_types', 'method', 'status']),
  'browser:browser_network_request': new Set(['request_id', 'include_request_body', 'include_response_body', 'max_body_chars']),
  'browser:browser_har_start': new Set([]),
  'browser:browser_har_stop': new Set(['path', 'include_request_bodies', 'include_response_bodies', 'max_body_chars', 'max_entries']),
  'browser:browser_websocket_start': new Set([]),
  'browser:browser_websocket_frames': new Set(['clear', 'limit', 'request_id', 'direction', 'include_text_payloads', 'max_payload_chars']),
  'browser:browser_websocket_stop': new Set([]),
  'browser:browser_route_add': new Set(['pattern', 'action']),
  'browser:browser_route_list': new Set([]),
  'browser:browser_route_remove': new Set(['route_id']),
  'browser:browser_route_clear': new Set([]),
  'browser:browser_cdp_command': new Set(['target', 'method', 'timeout_seconds']),
  ...
  'browser:chrome_status': new Set([]),
  'browser:chrome_tabs': new Set(['limit']),
  'browser:chrome_tab_snapshot': new Set(['tab_id', 'max_chars']),
  'browser:chrome_tab_navigate': new Set(['tab_id', 'url']),
  'browser:chrome_tab_click': new Set(['tab_id', 'target_id']),
  'browser:chrome_tab_type_text': new Set(['tab_id', 'target_id', 'replace']),
  'browser:chrome_tab_select': new Set(['tab_id', 'target_id', 'option_label']),
  'browser:chrome_tab_scroll': new Set(['tab_id', 'delta_x', 'delta_y']),
  'browser:chrome_tab_history': new Set(['tab_id', 'direction']),
  'browser:chrome_tab_activate': new Set(['tab_id']),
  'browser:chrome_tab_upload': new Set(['tab_id', 'target_id', 'path']),
  'browser:chrome_tab_download': new Set(['tab_id', 'target_id', 'path', 'max_bytes']),
  'browser:chrome_tab_screenshot': new Set(['tab_id', 'quality']),
  'browser:chrome_tab_release': new Set(['tab_id']),
  ...
  'agent:create_memory_agent': new Set(['name', 'role_definition', 'description', 'category', 'enabled', 'skill_ids', 'default_skill_ids', 'skills']),
  'agent:update_memory_agent': new Set(['agent_id', 'name', 'role_definition', 'description', 'category', 'enabled', 'skill_ids', 'default_skill_ids', 'skills']),
  'agent:preview_agent_context': new Set(['role_definition', 'skills', 'skill_ids']),
