...
use crate::builtin::research_output::normalize_inline_text;

pub(crate) fn response_search_results_brief(response: &Value) -> Option<&Vec<Value>> {
    response
        .get("search")
...
pub(crate) fn response_extract_results_brief(response: &Value) -> Option<&Vec<Value>> {
    response
        .get("extract")
        .and_then(|value| value.get("results_brief"))
        .and_then(|value| value.as_array())
...
pub(crate) fn top_search_hit_titles(
    response: &Value,
...
pub(crate) fn top_extract_source_titles(
    response: &Value,
    title_max_chars: usize,
...
pub(crate) fn response_research_warning(response: &Value) -> Option<&str> {
    response
...
pub(crate) fn response_source_highlights(response: &Value) -> Vec<Value> {
...
pub(crate) fn build_research_source_highlights(
...
pub(crate) fn push_unique_text(values: &mut Vec<String>, value: String) {
