...
use crate::tool_registry::{async_text_tool_handler, ToolRegistry};
...
impl RemoteConnectionControllerStoreRef {
    ...
    fn inner(&self) -> Arc<dyn RemoteConnectionControllerStore> {
        self.0.clone()
    }
}
