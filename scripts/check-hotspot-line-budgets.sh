...
BUDGETS=(
  ...
  "chat_app/src/components/sessionList/useProjectRunState.ts:760"
  "chat_app/src/lib/store/actions/remoteConnections.ts:580"
  "chat_app/src/components/chatInterface/useChatStreamRealtimeBridge.ts:500"
  "chat_app/src/components/terminal/useTerminalInstanceLifecycle.ts:480"
  ...
  "openai-codex-gateway/gateway_runtime/thread_session.py:100"
