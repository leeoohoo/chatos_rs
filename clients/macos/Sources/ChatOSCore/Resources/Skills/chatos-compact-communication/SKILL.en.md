...
3. Put full plans, long logs, code, large tables, and research detail in a Markdown document with `chat_document_create`, then attach it through `document_refs` on the same outgoing message.
