...
export const buildWorkspaceViewModelParams = (
  ...
  run: {
    ...
    sandboxToggleVisible: runState.sandboxToggleVisible,
    sandboxEnabled: runState.sandboxEnabled,
    sandboxLoading: runState.sandboxLoading,
    sandboxSaving: runState.sandboxSaving,
    sandboxError: runState.sandboxError,
    updateSandboxEnabled: runState.updateSandboxEnabled,
