...
impl McpManagementClientConfig {
    pub async fn from_env(caller_service: impl Into<String>) -> Self {
        ...
        let fallback = normalized_env("MCP_MANAGEMENT_SERVICE_URL")
            .or_else(|| normalized_env("MCP_MANAGEMENT_SERVICE_BASE_URL"))
            .unwrap_or_else(|| "http://127.0.0.1:39280".to_string());
        ...
        let request_timeout = Duration::from_millis(
            normalized_env("MCP_MANAGEMENT_REQUEST_TIMEOUT_MS")
        ...
        Self {
            ...
            request_timeout,
            internal_api_secret: normalized_env("MCP_MANAGEMENT_INTERNAL_API_SECRET"),
            caller_service,
        }
    }
