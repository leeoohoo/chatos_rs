...
fn bundled_plugin_specs_cover_all_twenty_eight_internal_skills_once() {
    ...
    let pdf = bundled_plugin_specs()
        ...
        .expect("PDF spec");
    assert_eq!(pdf.release_version, "1.15.0");
    assert_eq!(pdf.artifact_revision, "pdf-1.15.0");
...
fn bundled_releases_have_stable_component_and_content_snapshots() {
    ...
    let packaged_hashes = HashMap::from([
        ...
        (
            "pdf",
            (
                "0f7ef0973cd62b986a0dcd3bdfc89a1d919896b2244cf1c574d857d8a545fadf",
                "163e7b7567c3ca49e9efeb6d9707aad68849e8cd021e499ea9c08fe91a170e13",
            ),
        ),
        (
            "spreadsheets",
