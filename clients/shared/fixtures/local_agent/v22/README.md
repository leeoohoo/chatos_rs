# Local Agent protocol v22 fixtures
...
folder/note records, plus owner-scoped revision-bound Client Settings. Binary
payload bytes never enter this protocol.

Protocol v22 is the only supported native-client contract. Older fixture sets
