...
pub(super) fn definitions(now: &str) -> Vec<ConfigDefinitionRecord> {
    vec![
        ...
        definition(
            CHATOS_CLOUD_AGENT_OUTBOX_RECONCILE_MS_CONFIG_KEY,
            "Cloud Agent Outbox 补偿间隔",
            "低频补偿发布异常遗留的 ChatOS Cloud Agent 事件，不用于业务任务发现",
            "Chat OS / Cloud Agent",
            "service",
            Some("chatos-backend"),
            "duration_ms",
            ...
            &[],
            "restart_required",
            &["CHATOS_CLOUD_AGENT_OUTBOX_RECONCILE_MS"],
            1961,
            now,
        ),
        definition(
            CHATOS_CLOUD_AGENT_OUTBOX_BATCH_SIZE_CONFIG_KEY,
            "Cloud Agent Outbox 补偿批次",
            "单轮最多补偿发布的 ChatOS Cloud Agent 事件数量",
            "Chat OS / Cloud Agent",
            "service",
            Some("chatos-backend"),
            "integer",
            ...
            &[],
            "restart_required",
            &["CHATOS_CLOUD_AGENT_OUTBOX_BATCH_SIZE"],
            1962,
            now,
        ),
        nullable_definition(
