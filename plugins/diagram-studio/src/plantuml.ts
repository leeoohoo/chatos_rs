...
function mindMapDiagramToPlantUml(document: DiagramDocument): string {
...
function plantUmlMindMapToDiagram(source: string, options: PlantUmlImportOptions): DiagramDocument {
...
function mindMapColor(depth: number, side?: 'left' | 'right'): string {
