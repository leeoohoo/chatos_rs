...
export interface JobRun {
  ...
  session_contact_label?: string | null;
  session_project_label?: string | null;
  session_agent_label?: string | null;
  session_user_id?: string | null;
  session_title?: string | null;
  session_resolve_status?: string | null;
  session_resolve_detail?: string | null;
  session_resolve_match_mode?: string | null;
  session_id_effective?: string | null;
  session_id_raw_len?: number | null;
  session_id_trimmed_len?: number | null;
  status: string;
  trigger_type?: string | null;
  input_count: number;
  output_count: number;
  pending_before_count?: number | null;
  selected_count?: number | null;
  marked_count?: number | null;
  pending_after_count?: number | null;
  error_message?: string | null;
  started_at: string;
