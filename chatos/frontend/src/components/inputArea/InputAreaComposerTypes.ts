...
export interface InputAreaComposerProps {
  ...
  workspacePickerRef: InputAreaRefObject<HTMLDivElement>;
  projectFilePickerRef: InputAreaRefObject<HTMLDivElement>;
  fileInputRef: InputAreaRefObject<HTMLInputElement>;
  textareaRef: InputAreaRefObject<HTMLTextAreaElement>;
  message: string;
