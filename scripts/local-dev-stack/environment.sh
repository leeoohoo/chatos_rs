...
export_local_env() {
  ...
  export TASK_RUNNER_MCP_MANAGEMENT_MODE="${TASK_RUNNER_MCP_MANAGEMENT_MODE:-shadow}"
  ...
  export CHATOS_MCP_MANAGEMENT_MODE="${CHATOS_MCP_MANAGEMENT_MODE:-shadow}"
  ...
  export PROJECT_SERVICE_MCP_MANAGEMENT_MODE="${PROJECT_SERVICE_MCP_MANAGEMENT_MODE:-shadow}"
  ...
  export MCP_MANAGEMENT_CHATOS_SERVICE_BASE_URL="http://127.0.0.1:${MAIN_BACKEND_PORT}"
