...
MAIN_BACKEND_PORT="${CHATOS_RS_BACKEND_PORT:-3997}"
MAIN_FRONTEND_PORT="${CHATOS_RS_FRONTEND_PORT:-8088}"
MAIN_FRONTEND_HOST="${CHATOS_RS_FRONTEND_HOST:-127.0.0.1}"
...
start_main_frontend() {
  ...
  nohup bash -lc "cd \"$MAIN_FRONTEND_DIR\" && AGENT_ORCHESTRATOR_HOST=127.0.0.1 AGENT_ORCHESTRATOR_PORT=\"$MAIN_BACKEND_PORT\" npm run dev -- --host \"$MAIN_FRONTEND_HOST\" --port \"$MAIN_FRONTEND_PORT\"" >"$MAIN_FRONTEND_LOG_FILE" 2>&1 &
