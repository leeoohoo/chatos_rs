      ...
      >
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            onClick={onClose}
            disabled={submitBusy}
            className="rounded-lg bg-muted px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-accent disabled:opacity-60"
          >
            {t('common.cancel')}
          </button>
          <button
          ...
          >
            {terminalExecuting ? t('sessionList.resource.executing') : submitting ? submittingLabel || t('common.loading') : submitLabel}
          </button>
        </div>
      </form>
    </ManagerFormDialog>
