...
struct InternalSkillCatalog {
    catalog_revision: String,
    skills: Vec<InternalSkillCatalogItem>,
}

#[derive(Debug, Deserialize)]
struct InternalSkillCatalogItem {
    skill_id: String,
    bundle_id: String,
    version: String,
    name: String,
...
fn internal_skill_catalog() -> Result<InternalSkillCatalog, String> {
...
async fn seed_internal_skills(store: &AppStore, admin_user_id: &str) -> Result<(), String> {
