...
fn internal_skill_manifest(skill_id: &str) -> Option<&'static str> {
    match skill_id {
        ...
        "internal_skill_spreadsheets" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/spreadsheets/1.2.0/skill.json"
        )),
        ...
        "internal_skill_excel_live_control" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/excel-live-control/1.3.0/skill.json"
        )),
        _ => None,
    }
}
...
fn internal_skill_instructions(skill_id: &str) -> Option<&'static str> {
    match skill_id {
        ...
        "internal_skill_spreadsheets" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/spreadsheets/1.2.0/instructions.md"
        )),
        "internal_skill_template_creator" => Some(include_str!(
        ...
        "internal_skill_excel_live_control" => Some(include_str!(
            "../../../../local_connector_client/skill_bundles/internal/excel-live-control/1.3.0/instructions.md"
        )),
        _ => None,
    }
}
