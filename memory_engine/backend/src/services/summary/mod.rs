...
#[cfg(test)]
mod tests {
    use super::required_thread_summary_token_limit;

    #[test]
    fn summary_policy_preserves_configured_token_limit() {
        assert_eq!(
            required_thread_summary_token_limit(Some(250_000)),
            Ok(250_000)
        );
    }
