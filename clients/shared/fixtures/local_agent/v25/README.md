# Local Agent protocol v25 fixtures
...
Protocol v25 is the only supported native-client contract. Older fixture sets
are intentionally removed rather than retained as compatibility inputs.

v25 adds account- and device-scoped installed Plugin CRUD backed by the shared
