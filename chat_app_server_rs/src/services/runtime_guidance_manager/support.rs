...
pub(crate) fn format_runtime_guidance_instruction(guidance_item: &RuntimeGuidanceItem) -> String {
    format!(
...
mod tests {
    ...
    fn formats_runtime_guidance_instruction_with_core_fields() {
        let formatted = format_runtime_guidance_instruction(&sample_item());
