...
USER_SERVICE_FRONTEND_BASE_PATH="${USER_SERVICE_FRONTEND_BASE_PATH:-${VITE_BASE_PATH:-/}}"
USER_SERVICE_FRONTEND_API_BASE_URL="${USER_SERVICE_FRONTEND_API_BASE_URL:-${VITE_API_BASE_URL:-}}"
...
start_frontend() {
  ...
  launch_service \
    ...
    "$FRONTEND_PID_FILE" \
    "$FRONTEND_LOG_FILE" \
    "cd \"$FRONTEND_DIR\" && USER_SERVICE_FRONTEND_PORT=\"$USER_SERVICE_FRONTEND_PORT\" USER_SERVICE_API_PROXY_TARGET=\"$USER_SERVICE_API_PROXY_TARGET\" VITE_BASE_PATH=\"$USER_SERVICE_FRONTEND_BASE_PATH\" VITE_API_BASE_URL=\"$USER_SERVICE_FRONTEND_API_BASE_URL\" exec npm run dev -- --host 0.0.0.0 --port \"$USER_SERVICE_FRONTEND_PORT\""
}
