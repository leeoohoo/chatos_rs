...
fn bundled_plugin_specs_cover_all_twenty_eight_internal_skills_once() {
    ...
    let pdf = bundled_plugin_specs()
        ...
        .expect("PDF spec");
    assert_eq!(pdf.release_version, "1.18.0");
    assert_eq!(pdf.artifact_revision, "pdf-1.18.0");
...
fn bundled_releases_have_stable_component_and_content_snapshots() {
    ...
    let packaged_hashes = HashMap::from([
        ...
        (
            "pdf",
            (
                "9462ce96b5f2767f0e703546c5134786039e87acc1d28daa1aebbc7ed4c55c9e",
                "8a19694e91555b855a493d1d0a75c4639f06d45c83da54ba2ce1102c366cbc34",
            ),
        ),
        (
            "spreadsheets",
