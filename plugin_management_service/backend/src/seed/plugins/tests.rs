...
fn bundled_plugin_specs_cover_all_twenty_eight_internal_skills_once() {
    ...
    let pdf = bundled_plugin_specs()
        ...
        .expect("PDF spec");
    assert_eq!(pdf.release_version, "1.16.0");
    assert_eq!(pdf.artifact_revision, "pdf-1.16.0");
...
fn bundled_releases_have_stable_component_and_content_snapshots() {
    ...
    let packaged_hashes = HashMap::from([
        ...
        (
            "pdf",
            (
                "d4542f5a73a103b16891a7ee1170e139aed4b63b3690ee7a2ea06b60c6b671e7",
                "ced523a44e5d5a853468f9c1e3c75ae38c7ef8140a16f86fbc04615f4f2ef378",
            ),
        ),
        (
            "spreadsheets",
