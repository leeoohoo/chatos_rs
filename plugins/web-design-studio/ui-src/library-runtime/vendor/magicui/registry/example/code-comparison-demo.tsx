// @ts-nocheck
import { CodeComparison } from "@magic/registry/magicui/code-comparison"
...
import { auth } from '@magic/app/(auth)/auth/_middleware'; // [!code --]
import { auth } from '@magic/app/(auth)/auth/_middleware'; // [!code ++]
import { team } from '@magic/app/(team)/team/_middleware';
