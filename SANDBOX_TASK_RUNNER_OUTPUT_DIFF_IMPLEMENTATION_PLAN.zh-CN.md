...
- `chat_app/src/components/messageTasks/MessageTaskGraphNode.tsx`
  - 截图中的任务卡片按钮区域，目前有“执行过程 / 详情 / 运行详情”。
- `chat_app/src/components/projectExplorer/git/GitDiffDialog.tsx`
...
在 `chat_app_server_rs/src/api/message_task_runner.rs` 新增：
...
在 `chat_app_server_rs/src/services/task_runner_api_client.rs` 新增：
...
- `chat_app/src/lib/api/client/types/messageTaskRunner.ts`
...
- 新建 `chat_app/src/components/messageTasks/MessageTaskChangesModal.tsx`：
