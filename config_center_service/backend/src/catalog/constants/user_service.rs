...
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_APP_ID_CONFIG_KEY: &str =
    "user_service.wechat_mini_program.app_id";
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_APP_SECRET_CONFIG_KEY: &str =
    "user_service.wechat_mini_program.app_secret";
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_IDENTITY_HASH_SECRET_CONFIG_KEY: &str =
    "user_service.wechat_mini_program.identity_hash_secret";
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_API_BASE_URL_CONFIG_KEY: &str =
    "user_service.wechat_mini_program.api_base_url";
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_ENV_VERSION_CONFIG_KEY: &str =
    "user_service.wechat_mini_program.env_version";
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_REQUEST_TIMEOUT_MS_CONFIG_KEY: &str =
    "user_service.wechat_mini_program.request_timeout_ms";
pub const USER_SERVICE_WECHAT_MINI_PROGRAM_BIND_TICKET_TTL_SECONDS_CONFIG_KEY: &str =
