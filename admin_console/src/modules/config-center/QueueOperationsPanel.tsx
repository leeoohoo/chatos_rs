...
export function QueueOperationsPanel({ environment }: QueueOperationsPanelProps) {
  ...
  const query = useQuery({
    queryKey: ['config-center', 'queue-operations', environment],
  ...
  const replay = useMutation({
    ...
    onSuccess: async (result) => {
      ...
      setReplayReason('');
      await queryClient.invalidateQueries({ queryKey: ['config-center', 'queue-operations', environment] });
      await queryClient.invalidateQueries({ queryKey: ['config-center', 'audit'] });
    },
