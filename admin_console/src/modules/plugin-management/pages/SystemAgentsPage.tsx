...
export function SystemAgentsPage({ user, onOpenPromptSettings }: SystemAgentsPageProps) {
  ...
  const agentsQuery = useQuery({
    queryKey: ['plugin-management', 'system-agents'],
    queryFn: api.listSystemAgents,
    enabled: isAdmin,
  });

  const completenessQuery = useQuery({
    queryKey: ['plugin-management', 'agent-prompt-completeness'],
  ...
  const bindingsQuery = useQuery({
    queryKey: ['plugin-management', 'agent-mcp-bindings', selectedAgentKey],
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.setQueryData(['plugin-management', 'agent-mcp-bindings', selectedAgentKey], data);
      setModalOpen(false);
    },
