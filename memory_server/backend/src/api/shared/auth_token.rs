...
pub(crate) fn build_auth_token(user_id: &str, role: &str, secret: &str, ttl_hours: i64) -> String {
...
pub(crate) fn parse_auth_token(token: &str, secret: &str) -> Option<(String, String, i64)> {
