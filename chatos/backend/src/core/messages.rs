...
mod tests {
    ...
    #[test]
    fn terminal_async_status_keeps_generic_mode() {
        let mut message = Message::new(
            "session_1".to_string(),
            "user".to_string(),
            "task".to_string(),
    ...
    #[test]
    fn async_completion_keeps_message_processing_while_created_tasks_are_active() {
        let mut message = Message::new(
            "session_1".to_string(),
            "user".to_string(),
            "task".to_string(),
    ...
    #[test]
    fn async_finalize_does_not_overwrite_terminal_callback_failure() {
        let mut message = Message::new(
            "session_1".to_string(),
            "user".to_string(),
            "task".to_string(),
    ...
    #[test]
    fn async_finalize_does_not_overwrite_zero_task_failure() {
        let mut message = Message::new(
            "session_1".to_string(),
            "user".to_string(),
            "task".to_string(),
