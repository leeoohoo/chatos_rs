...
pub struct SearchResultsBriefOptions {
    pub fallback_title_to_url: bool,
}

#[derive(Debug, Clone, Copy)]
pub struct SearchSummaryLineOptions {
    pub label_prefix: Option<&'static str>,
    pub fallback_title_to_url: bool,
    pub title_max_chars: usize,
    pub url_max_chars: usize,
    pub description_max_chars: usize,
}

#[derive(Debug, Clone, Copy)]
pub enum ExtractStatusStyle {
    Canonical,
    HumanReadable,
}

#[derive(Debug, Clone, Copy)]
pub struct ExtractResultsBriefOptions {
    pub fallback_title_to_url: bool,
    pub status_style: ExtractStatusStyle,
    pub status_error_max_chars: usize,
    pub ok_preview_max_chars: usize,
    pub error_preview_max_chars: usize,
    pub blank_preview_on_error: bool,
    pub include_error_field: bool,
    pub include_stats_fields: bool,
}

#[derive(Debug, Clone, Copy)]
pub struct ExtractSummaryLineOptions {
    pub label_prefix: Option<&'static str>,
    pub fallback_title_to_url: bool,
    pub title_max_chars: usize,
    pub url_max_chars: usize,
...
pub fn build_search_summary_line(
    index: usize,
    hit: &SearchHit,
...
pub fn build_extract_summary_line(
    index: usize,
    page: &ExtractedPage,
...
pub fn build_search_results_brief(
    hits: &[SearchHit],
...
pub fn build_extract_results_brief(
    pages: &[ExtractedPage],
...
pub fn normalize_inline_text(text: &str, max_chars: usize) -> String {
    if max_chars == 0 {
        return String::new();
    }
