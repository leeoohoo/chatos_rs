...
@Suite("Shared Local Agent protocol v27 fixtures")
struct LocalAgentProtocolV27FixtureTests {
    ...
    func retryTaskRequest() throws {
        ...
        #expect(localAgentProtocolVersion == 27)
    ...
    private func fixtureURL(_ name: String) -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/fixtures/local_agent/v27")
