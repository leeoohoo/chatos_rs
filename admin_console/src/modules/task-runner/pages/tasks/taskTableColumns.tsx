      ...
      render: (value?: string | null) => {
        ...
        return (
          <Button
            ...
            onClick={() => navigate(`/task-runner/tasks?project_id=${encodeURIComponent(projectId)}`)}
          >
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space wrap>
          ...
          <Button
            size="small"
            onClick={() => navigate(`/task-runner/runs?task_id=${encodeURIComponent(record.id)}`)}
          >
            {t('tasks.action.history')}
          </Button>
          <Button
            size="small"
            onClick={() => navigate(`/task-runner/prompts?task_id=${encodeURIComponent(record.id)}`)}
          >
