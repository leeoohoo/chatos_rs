...
import type {
  WebComponentType,
  WebDesignDevice,
  WebDesignLibraryName,
  WebContainerLayoutMode,
  WebContainerAlign,
  WebContainerJustify,
  AnnotationStatus,
  DesignRequestStatus,
  WebSymbolOverride,
  WebHorizontalConstraint,
  WebComponentVisualState,
  WebDesignSurfaceKind,
  WebDesignPage,
  WebDesignAsset,
  WebDesignTokens,
  WebDesignSymbol,
  WebComponentStyle,
  WebComponentStates,
  WebDesignInteraction,
  WebDesignJsonValue,
  WebDesignLibraryBinding,
  WebDesignAnnotation,
  WebDesignComponent,
  WebComponentConstraints,
  WebContainerLayout,
  WebComponentResponsiveOverride,
  WebDesignRequest,
  WebDesignViewport,
  WebDesignBreakpoint,
  WebDesignBreakpoints,
  WebDesignProject,
  WebDesignProjectSummary,
  WebDesignDocument,
  WebDesignPatchOperation
