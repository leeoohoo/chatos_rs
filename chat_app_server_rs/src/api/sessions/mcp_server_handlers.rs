...
pub(super) async fn list_mcp_servers(
    ...
    match session_mcp_repo::list_session_mcp_servers(&conversation_id).await {
        Ok(res) => (
            StatusCode::OK,
...
pub(super) async fn add_mcp_server(
    ...
    (
        ...
        Json(serde_json::json!({
            ...
            "mcp_config_id": req.mcp_config_id
        })),
    )
}
...
pub(super) async fn delete_mcp_server(
    ...
    match session_mcp_repo::delete_session_mcp_server(&conversation_id, &mcp_config_id).await {
        Ok(_) => (
            StatusCode::OK,
            Json(
