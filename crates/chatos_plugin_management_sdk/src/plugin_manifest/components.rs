...
pub const PLUGIN_UI_BRIDGE_CAPABILITY_TASK_BATCH_PREPARE: &str = "task.batch.prepare";
pub const PLUGIN_UI_BRIDGE_CAPABILITY_TASK_BATCH_STATUS: &str = "task.batch.status";
pub const PLUGIN_UI_BRIDGE_CAPABILITY_TASK_WORKSPACE_OPEN: &str = "task.workspace.open";
