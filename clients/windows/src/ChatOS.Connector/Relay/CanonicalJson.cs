...
internal static class CanonicalJson
{
    ...
    private static void Write(JsonElement value, StringBuilder output)
    {
        switch (value.ValueKind)
        {
            ...
            case JsonValueKind.Object:
                ...
                break;
            default:
                throw new RelayRequestException(400, "Relay signature JSON contains an unsupported value.");
        }
    }
    ...
    private static void WriteNumber(JsonElement value, StringBuilder output)
    {
        ...
        {
            throw new RelayRequestException(400, "Relay signature JSON number is not finite.");
        }
