...
> 状态：实施中
> 创建日期：2026-07-21
> 最新增量（Presentations canonical 图表系列颜色）：2026-07-27 新增 Presentations `1.25.0` 的可选严格 `#RRGGBB` 系列颜色。创建、追加、检查与安全替换对五类 canonical 图表使用同一合同：line 写入 exact line color，column/area/pie/doughnut 写入 exact fill color；输入规范化为大写，省略或 `null` 时保持旧 canonical XML 不生成 `c:spPr`。检查返回 recognized/custom/null 状态与 raw OOXML RGB，复杂 transform、重复样式、错误 namespace、错误属性或结构只允许有界只读检查，不获得完整编辑快照或替换资格。不可变 Release ID 为 `bundled-release-presentations-1-25-0`，发布时间 `2026-07-28T00:00:00Z`，artifact revision `presentations-1.25.0`，Catalog revision `2026-07-27.14`；Skill JSON/Instructions SHA-256 为 `3b849979e4566cab1a2dae7c2f563037855b3d831e1c760c59e7e9483732fe5c`/`cd75afed4d297b23e39fd7b0ffa5951514ec3ccb5a609026711409fb3d035eb9`，Bundle hash 为 `297c9a38b9fba8a88c01b9a961f628264d5616ff2eab1a5aed636aff5915f398`，Manifest/Artifact SHA-256 为 `d818dbf3635d4972aa1c87316cd6b37bca98bd9c66f69a45530882c06a12531b`/`7c485c262c17c3492bef7cec7e97bf4fe98564fd73fa716a87f67db68db968aa`，macOS arm64/Windows x64 staged content SHA-256 均为 `9f4c3a4a2948d53f017af3b920ff20d3bbbfcda4f9075469f9a7f4d9021e7e63`，ready/all fingerprints 分别为 `9488ae6994187a5184b9857b332fe20c9ecce7e13220ff44efc352bda92ceae3` 和 `a9747ecbafa1d81cce4c3e5ecdc4cb47737c75d62fcef1e3ff9a59bd9f1ae3b3`。
