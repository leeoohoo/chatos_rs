...
> 状态：实施中
> 创建日期：2026-07-21
> 最新增量（Presentations canonical 折线图系列平滑）：2026-07-27 新增 Presentations `1.27.0` 的 line-series `smooth`。line series 接受 `true/false/null`，省略或 `null` 默认 `false`；非 line 图表不允许非空配置。创建、追加、检查、完整快照和安全替换使用同一 direct-series canonical `<c:smooth val="0|1"/>` 合同，并保留既有 line-chart group `smooth=false` 拓扑；检查返回 boolean/custom/null 与 raw OOXML value，未知或超长值、重复节点、错误 namespace、错误属性或结构只允许有界只读检查，不获得完整编辑快照或替换资格。不可变 Release ID 为 `bundled-release-presentations-1-27-0`，发布时间 `2026-07-28T02:00:00Z`，artifact revision `presentations-1.27.0`，Catalog revision `2026-07-27.16`；Skill JSON/Instructions SHA-256 为 `03266031ed63e0bd651483c3203eecfcaa0def8d833e8656a7c0df5a9a54a08a`/`76128f14e7d90ef8d614ad8b84f68622bb9ea85af0b1356cba9f1bc57e65a70a`，Bundle hash 为 `3c38609acfef495d0aad2b3595b665147ce7de439ab3113cc11eb65f6db623a9`，Manifest/Artifact SHA-256 为 `31af2bdffd6057ac566a7d1740d74d270992cea04cd2f85251da574503fe3d26`/`e21539f566a092f7c2b844e4e1ccf1caf62881cecf473d10e9f23c577df243e3`，macOS arm64/Windows x64 staged content SHA-256 均为 `3defc6e67008e175448182e4b8ea40664a6e7446e606407fdb1f72fb6fae4e92`，ready/all fingerprints 分别为 `f3ef5c3ca4e0ca316bbe47e1c18df0565b953c69fc14ea7ff1c13db65ae4f886` 和 `fb40fec30210da55549af244386cbe48524c1ed336ad18a53330a37ea9624920`。
