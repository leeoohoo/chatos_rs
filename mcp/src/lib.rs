...
pub use implementations::builtin::{
    agent_browser_binary_path, browser_interactive_approval_command, build_shared_builtin_provider,
    ...
    discover_bundled_tool_dirs, extract_patch_targets, normalize_kv_fields,
    path_with_bundled_tools, resolve_wait_timeout_ms, terminal_process_list_entry,
    terminal_process_list_response, terminal_process_log_response, terminal_process_poll_response,
    terminal_process_wait_response, terminal_recent_logs_entry, terminal_recent_logs_response,
    terminal_result_scope, terminate_child_process_tree, AgentBuilderOptions, AgentBuilderService,
    AgentBuilderSkill, AgentBuilderStore, AgentBuilderStoreRef, AskUserDecision, AskUserOptions,
    AskUserPromptPayload, AskUserResponseSubmission, AskUserService, AskUserStore, AskUserStoreRef,
    ...
    TerminalRecentLogsEntry, WebToolsOptions, WebToolsService, AGENT_BROWSER_BIN_ENV,
    ASK_USER_PROMPT_TIMEOUT_MS_DEFAULT, CHATOS_BUNDLED_TOOLS_DIR_ENV,
