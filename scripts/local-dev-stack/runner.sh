...
APISIX_RUNTIME_DIR="${CHATOS_LOCAL_DEV_APISIX_RUNTIME_DIR:-/tmp/chatos-local-dev-${UID}/apisix}"
export CHATOS_APISIX_RUNTIME_CONFIG_PATH="${CHATOS_APISIX_RUNTIME_CONFIG_PATH:-$APISIX_RUNTIME_DIR/config.yaml}"
export CHATOS_APISIX_RUNTIME_ROUTES_PATH="${CHATOS_APISIX_RUNTIME_ROUTES_PATH:-$APISIX_RUNTIME_DIR/apisix.yaml}"
