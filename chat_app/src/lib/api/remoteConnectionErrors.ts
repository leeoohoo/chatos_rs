...
export const REMOTE_CONNECTION_ERROR_CODE_ACTIONS: Record<string, string> = {
  ...
  auth_failed:
    '请检查用户名、认证方式、私钥/证书路径或密码是否正确。若目标机开启短信验证码/OTP，请按弹窗提示输入验证码后重试。',
  second_factor_required: '请输入手机验证码/OTP 后继续连接。',
...
export const REMOTE_SFTP_ERROR_CODE_ACTIONS: Record<string, string> = {
  ...
  second_factor_required: '请输入短信验证码/OTP 后继续当前 SFTP 操作。',
