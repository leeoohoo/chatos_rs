...
export const useConversationPaneProps = ({
  ...
  onStop: actions.handleStopMessage,
  isLoading: conversation.isLoading,
  isStreaming: conversation.isStreaming,
  isStopping: conversation.isStopping,
  streamingPhase: conversation.streamingPhase,
  streamingPreviewText: conversation.streamingPreviewText,
  inputDisabled: conversation.reviewRepairRunning || !conversation.currentSession,
