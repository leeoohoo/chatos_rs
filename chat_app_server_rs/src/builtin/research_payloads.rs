...
pub(crate) fn build_search_payload_from_outcome(
...
pub(crate) fn build_search_payload(
    backend: &str,
    fallback_used: bool,
...
pub(crate) fn build_empty_search_payload() -> Value {
    json!({
        "backend": "none",
        "fallback_used": false,
        "provider_attempts": [],
...
pub(crate) fn build_extract_payload_from_outcome(
...
pub(crate) fn build_extract_payload_from_research(
...
pub(crate) fn build_extract_payload(
    backend: &str,
    fallback_used: bool,
    provider_attempts: &[ProviderAttempt],
    pages: &[crate::builtin::web_tools::provider::ExtractedPage],
...
pub(crate) fn build_empty_extract_payload(max_extract_chars: usize) -> Value {
    json!({
        "backend": "none",
        "fallback_used": false,
        "provider_attempts": [],
...
pub(crate) fn build_extract_summary_payload(
    stats: ResearchExtractStats,
    max_extract_chars: usize,
) -> Value {
    json!({
