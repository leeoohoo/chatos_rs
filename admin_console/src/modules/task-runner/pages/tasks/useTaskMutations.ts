...
export function useTaskMutations({
  ...
  const invalidateTaskQueries = useCallback(async () => {
    await Promise.all([
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'tasks'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-index'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-stats'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'task'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-recent-runs'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-prompts'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'runs'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'run-index'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-list-last-run-events'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'model-config-usage'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'prompts'] }),
      queryClient.invalidateQueries({ queryKey: ['task-runner', 'prompt-task-counts'] }),
    ]);
  }, [queryClient]);
  ...
  const summarizeTaskMemoryMutation = useMutation({
    ...
    onSuccess: async (_, taskId) => {
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-memory-context', taskId] }),
        queryClient.invalidateQueries({ queryKey: ['task-runner', 'task-memory-records', taskId] }),
      ]);
