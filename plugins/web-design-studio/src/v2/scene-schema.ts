export * from './scene-schema-types.js';
import type {
  SceneNodeId,
  SceneNodeType,
  SceneCreator,
  ...
  SceneComponentMainNode,
  SceneComponentPropertyDefinition,
  SceneComponentSetNode,
  SceneComponentInstanceNode,
  SceneContainerNode,
  SceneNode,
  SceneSlotContainerNode,
  ScenePage,
  SceneVariable,
