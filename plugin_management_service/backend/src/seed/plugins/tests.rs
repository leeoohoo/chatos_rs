...
fn bundled_plugin_specs_cover_all_twenty_eight_internal_skills_once() {
    ...
    assert_eq!(spreadsheets.release_version, "1.6.0");
    assert_eq!(spreadsheets.artifact_revision, "spreadsheets-1.6.0");
...
fn bundled_releases_have_stable_component_and_content_snapshots() {
    ...
    let packaged_hashes = HashMap::from([
        ...
        (
            "spreadsheets",
            (
                "e0679749aef8963983bd059d7c3d3f40b81d09a840c251e44920c3aa74e8c368",
