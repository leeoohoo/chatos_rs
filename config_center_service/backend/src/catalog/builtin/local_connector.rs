...
pub(super) fn definitions(now: &str) -> Vec<ConfigDefinitionRecord> {
    vec![
        ...
        definition(
            ...
            "Controlled Network Policy TTL",
            "Local Connector Service 签发 Windows 受控域名网络策略时使用的有效期（秒）",
            "Local Connector / Controlled Network",
            "service",
            Some("local-connector-service"),
            "integer",
            json!(300),
        ...
        nullable_definition(
            ...
            "Controlled Network 签名私钥路径",
            "Local Connector Service 对 Windows 受控域名网络策略进行 Ed25519 签名时使用的独立私钥文件路径",
            "Local Connector / Controlled Network",
            "service",
            Some("local-connector-service"),
            "string",
        ...
        nullable_definition(
            ...
            "Controlled Network 签名 Key ID",
            "Local Connector Service 对 Windows 受控域名网络策略签名时附带的 key id；必须与独立私钥路径同时配置",
            "Local Connector / Controlled Network",
            "service",
            Some("local-connector-service"),
            "string",
