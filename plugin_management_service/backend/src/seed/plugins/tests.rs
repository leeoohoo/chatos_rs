...
fn bundled_plugin_specs_cover_all_twenty_eight_internal_skills_once() {
    ...
    let pdf = bundled_plugin_specs()
        ...
        .expect("PDF spec");
    assert_eq!(pdf.release_version, "1.19.0");
    assert_eq!(pdf.artifact_revision, "pdf-1.19.0");
...
fn bundled_releases_have_stable_component_and_content_snapshots() {
    ...
    let packaged_hashes = HashMap::from([
        ...
        (
            "pdf",
            (
                "32961458374f2ce7ae8250b9f7e25b5a041eabc63466750ac0ab50918de4d3f4",
                "ad1cdc924430fc7e08619d38db83149dedeee10e9705151d6f6ed547b23c2bc6",
            ),
        ),
        (
            "spreadsheets",
