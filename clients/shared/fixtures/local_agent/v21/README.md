# Local Agent protocol v21 fixtures
...
folder/note records. Binary payload bytes never enter this protocol.

Protocol v21 is the only supported native-client contract. Older fixture sets
