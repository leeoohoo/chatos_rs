...
pub(super) fn definitions(now: &str) -> Vec<ConfigDefinitionRecord> {
    vec![
        ...
        secret_definition(
            ...
            "User Service 校验 Memory Engine 运行时模型读取请求时使用的共享密钥",
            "User Service / Security",
            "service",
            Some("user-service"),
        ...
        nullable_definition(
            ...
            "微信小程序 AppID",
            "ChatOS Companion 微信小程序的 AppID；与 AppSecret、身份哈希密钥同时配置后启用微信登录",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            "string",
            Value::Null,
        ...
        nullable_secret_definition(
            ...
            "微信小程序 AppSecret",
            "ChatOS Companion 微信小程序服务端 code2Session 使用的 AppSecret",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            Value::Null,
        ...
        nullable_secret_definition(
            ...
            "微信身份哈希密钥",
            "对微信 OpenID、UnionID、绑定票据和 claim secret 做域隔离哈希的独立密钥，不得与 JWT 密钥复用",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            Value::Null,
        ...
        definition(
            ...
            "微信 API 地址",
            "微信小程序 code2Session API 的基础地址",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            "string",
            json!("https://api.weixin.qq.com"),
            None,
            None,
            &[],
            "restart_required",
        ...
        definition(
            ...
            "微信小程序码版本",
            "生成小程序码时打开的版本；生产使用 release，体验版联调使用 trial，开发版使用 develop",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            "enum",
        ...
        definition(
            ...
            "微信 API 请求超时",
            "调用微信 code2Session API 的超时时间，单位毫秒",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            "duration_ms",
        ...
        definition(
            ...
            "微信小程序会话有效期",
            "ChatOS Companion 小程序访问令牌和客户端会话的有效期，单位秒",
            "User Service / WeChat Mini Program",
            "service",
            Some("user-service"),
            "integer",
