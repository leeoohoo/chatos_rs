...
export_local_env() {
  ...
  export LOCAL_CONNECTOR_COMMAND_APPROVAL_MCP_MANAGEMENT_MODE="${LOCAL_CONNECTOR_COMMAND_APPROVAL_MCP_MANAGEMENT_MODE:-shadow}"
  export LOCAL_CONNECTOR_COMMAND_APPROVAL_MCP_MANAGEMENT_TOOL_TIMEOUT_MS="${LOCAL_CONNECTOR_COMMAND_APPROVAL_MCP_MANAGEMENT_TOOL_TIMEOUT_MS:-180000}"
  export LOCAL_CONNECTOR_MCP_MANAGEMENT_TOOL_TIMEOUT_MS="${LOCAL_CONNECTOR_MCP_MANAGEMENT_TOOL_TIMEOUT_MS:-180000}"
