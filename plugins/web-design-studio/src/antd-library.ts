...
import { ANTD_OFFICIAL_COMPONENT_VARIANTS } from './antd-registry.generated.js';
...
export const ANTD_COMPONENT_VARIANTS: Record<string, AntdComponentVariant[]> = Object.fromEntries(
  Object.entries(ANTD_OFFICIAL_COMPONENT_VARIANTS).map(([componentId, variants]) => [
    componentId,
    variants.map((variant) => ({ ...variant, props: { ...variant.props } }))
  ])
);
