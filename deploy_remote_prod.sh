...
prepare_aux_service_env() {
  ...
  export VITE_MEMORY_ENGINE_API_BASE="${VITE_MEMORY_ENGINE_API_BASE:-/api/memory-engine/v1}"
  export VITE_USER_SERVICE_API_BASE="${VITE_USER_SERVICE_API_BASE:-/}"
  ...
  export TASK_RUNNER_VITE_API_BASE_URL="${TASK_RUNNER_VITE_API_BASE_URL:-/}"
